...
write.csv(res_meta, file = "ICB_small_Mariathasan_meta_analysis_os__CXCL9_assosiation.csv", row.names = FALSE)
write.csv(res_meta, file = "ICB_small_Mariathasan_meta_analysis_os__CXCL9_pancancer.csv", row.names = FALSE)
write.csv(res_meta, file = "ICB_small_Mariathasan_meta_analysis_os__CXCL9_percancer.csv", row.names = FALSE)
