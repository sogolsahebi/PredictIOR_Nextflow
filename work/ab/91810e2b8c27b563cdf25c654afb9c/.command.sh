...
save(res.logreg, file = file.path("/results/association", paste(study.icb , "sig_logreg.rda", sep = "_")))


# Save as CSV file
write.csv(logreg, file = "ICB_small_Mariathasan__GeneSig_Response.csv", row.names = FALSE)
