...
res_meta_pertreatment <- metaPerTreatmentfun(coef = assoc.res$Coef, 
 ...
 write.csv(assoc.res, file = "Meta_analysis_os__CXCL9_assosiation.csv", row.names = FALSE)
 write.csv(res_meta_pancancer, file = "Meta_analysis_os__CXCL9_pancancer.csv", row.names = FALSE)
 write.csv(res_meta_percancer , file = "Meta_analysis_os__CXCL9_percancer.csv", row.names = FALSE)
 write.csv(res_meta_pertreatment , file = "Meta_analysis_os__CXCL9_pertreatment.csv", row.names = FALSE)
