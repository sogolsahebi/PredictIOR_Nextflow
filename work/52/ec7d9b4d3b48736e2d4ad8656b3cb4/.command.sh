...
res_meta_percancer_df <- do.call(rbind, res_meta_percancer_df$meta_summery)
print("meta_summery")
print(meta_summery_df)


write.csv(res_meta_percancer_df, file = "Meta_analysis_os_CXCL9_percancer.csv", row.names = FALSE)
