...
geneSig.score <- read.csv("ICB_small_Liu_GeneSigScore.csv")
...
res <- geneSigLogReg(dat.icb = ICB_small_Liu,
...
# Save as CSV file
write.csv(res.logreg, file = "ICB_small_Liu_GeneSig_Response.csv", row.names = TRUE)
