...
# Load all .rda files
lapply(ICB_small_Hugo.rda ICB_small_Liu.rda ICB_small_Mariathasan.rda ICB_small_Miao.rda ICB_small_Nathanson.rda ICB_small_Padron.rda ICB_small_Riaz.rda ICB_small_Van_Allen.rda, function(file) {
...
write.csv(data.frame(res_meta), file = "Meta_analysis_OS_CXCL9.csv", row.names = FALSE)
