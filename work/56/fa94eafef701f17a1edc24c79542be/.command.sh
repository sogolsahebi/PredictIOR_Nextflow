...
gene_vector <- unlist(strsplit(""CXCL9", "CXCL10", "TIGIT", "CD83", "STAT1", "CXCL11", "CXCL13", "CD8A", "CTLA4"", ",\s*"))
...
cox_result <- geneSurvCont(
    ...
    const.int = 0.001,
    n.cutoff = 15,
    feature = unlist(strsplit(""CXCL9", "CXCL10", "TIGIT", "CD83", "STAT1", "CXCL11", "CXCL13", "CD8A", "CTLA4"", ", ")),
