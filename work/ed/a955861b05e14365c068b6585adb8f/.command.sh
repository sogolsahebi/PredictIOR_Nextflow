...
expr <- read.csv("ICB_small_Liu_expr.csv", row.names = 1)
clin <- read.csv("ICB_small_Liu_clin.csv")
...
write.csv(cox_result, file = "ICB_small_Liu_cox_pfs.csv", row.names = FALSE)
