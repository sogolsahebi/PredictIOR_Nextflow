...
res_meta_pertreatment <- metaPerTreatmentfun(coef = assoc.res$Coef, 
 ...
 res_meta_pertreatment <- rbind(res_meta$`PD-1/PD-L1`$meta_summery,res_meta$Other$meta_summery)

 # Save the results to a CSV file
 write.csv(assoc.res, file = "ICB_small_Mariathasan_meta_analysis_os__CXCL9_assosiation.csv", row.names = FALSE)
 write.csv(res_meta_pancancer, file = "ICB_small_Mariathasan_meta_analysis_os__CXCL9_pancancer.csv", row.names = FALSE)
 write.csv(res_meta_percancer , file = "ICB_small_Mariathasan_meta_analysis_os__CXCL9_percancer.csv", row.names = FALSE)
 write.csv(res_meta_pertreatment , file = "ICB_small_Mariathasan_meta_analysis_os__CXCL9_pertreatment.csv", row.names = FALSE)
