...
geneSig.score <- read.csv("ICB_small_Van_Allen_GeneSigScore.csv", row.names = 1)
...
write.csv(res.all, file = "ICB_small_Van_Allen_pfs_GeneSig_association.csv", row.names = TRUE)
