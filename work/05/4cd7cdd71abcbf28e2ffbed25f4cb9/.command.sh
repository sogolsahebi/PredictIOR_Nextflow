...
# Check the sample IDs in the clinical data and expression matrix
cat("Sample IDs in clinical data (rownames):\n")
print(head(rownames(clin)))
cat("Column names in expression matrix:\n")
